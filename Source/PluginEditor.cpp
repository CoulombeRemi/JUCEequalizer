...
{
	// low shelf
	ls_gain.setBounds(50, 20, 20, getHeight() - 50);
	ls_freq.setBounds(80, 20, 20, getHeight() - 50);
	ls_q.setBounds(110,20,20, getHeight() - 50);
	// peak 01
	peak01_gain.setBounds(150,20, 20, getHeight() - 50);
	peak01_freq.setBounds(180,20,20,getHeight()-50);
	peak01_q.setBounds(210, 20, 20, getHeight() - 50);
	// peak 02
	peak02_gain.setBounds(250, 20, 20, getHeight() - 50);
	peak02_freq.setBounds(280, 20, 20, getHeight() - 50);
	peak02_q.setBounds(310, 20, 20, getHeight() - 50);
	// peak 03
	peak03_gain.setBounds(350, 20, 20, getHeight() - 50);
	peak03_freq.setBounds(380, 20, 20, getHeight() - 50);
	peak03_q.setBounds(410, 20, 20, getHeight() - 50);
	// peak 04
	peak04_gain.setBounds(450, 20, 20, getHeight() - 50);
	peak04_freq.setBounds(480, 20, 20, getHeight() - 50);
	peak04_q.setBounds(510, 20, 20, getHeight() - 50);
	// peak 05
	peak05_gain.setBounds(550, 20, 20, getHeight() - 50);
	peak05_freq.setBounds(580, 20, 20, getHeight() - 50);
	peak05_q.setBounds(610, 20, 20, getHeight() - 50);
	// peak 06
	peak06_gain.setBounds(650, 20, 20, getHeight() - 50);
	peak06_freq.setBounds(680, 20, 20, getHeight() - 50);
	peak06_q.setBounds(710, 20, 20, getHeight() - 50);
	// high shelf
	hs_gain.setBounds(750, 20, 20, getHeight() - 50);
	hs_freq.setBounds(780, 20, 20, getHeight() - 50);
	hs_q.setBounds(810,20, 20, getHeight() - 50);
}
